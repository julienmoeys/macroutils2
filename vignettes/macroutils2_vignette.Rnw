...
filenm <- c( "chat_winCer_GW-D_1kgHa_d298_annual_output.bin", 
    "chat_pot_GW-D_1kgHa_d119_biennial_output.bin" ) 
...
If you want to convert \texttt{"chat\_winCer\_GW-D\_1kgHa\_d298\_annual\_output.bin"} using R commands, type:

<<echo=TRUE,eval=FALSE>>= 
macroConvertBin( 
    f   = "chat_winCer_GW-D_1kgHa_d298_annual_output.bin", 
    gui = FALSE ) 
@ 
...
macroConvertBin( 
    ...
    sep     = ";",              # Field separator 
    dec     = ".",              # Decimal mark 
    fileOut = "chat_winCer_GW-D_1kgHa_d298_annual_output_2.csv" )   
@ 
...
<<echo=TRUE,eval=FALSE>>= 
macroViewBin( "chat_winCer_GW-D_1kgHa_d298_annual_output.bin" ) 
@ 
